...
# Remove the broken duplicate replace from the previous execution if it exists
broken = """<div style={{ display: "flex", gap: "8px" }}>
            <ImportPlanDialog onImport={onImportPlan} />
            <EntityDialog"""
content = content.replace(broken, "<EntityDialog")
